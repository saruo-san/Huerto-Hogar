  ...
  return (
    <div className="home">
      ...
      <section className="carrusel">
        <Carousel slides={[
          <img src="/images/inicio/background.png" className="d-block w-100" alt="Imagen 1" />,
          <img src="/images/inicio/jardineros.jpg" className="d-block w-100" alt="Imagen 2" />,
          <img src="/images/inicio/semillas.jpg" className="d-block w-100" alt="Imagen 3" />
        ]} />
      </section>
          ...
          <div className="row justify-content-center">
            <div className="col-md-4 mb-4">
              <div className="categoria-card">
                <img src="/images/inicio/semillas-cuenco.jpg" alt="Semillas" />
            ...
            <div className="col-md-4 mb-4">
              <div className="categoria-card">
                <img src="/images/inicio/libros.png" alt="Libros" />
                <div className="card-body">
                  <h5>LIBROS</h5>
                </div>
              </div>
            ...
            <div className="col-md-4 mb-4">
              <div className="categoria-card">
                <img src="/images/inicio/sustratos.png" alt="Sustratos" />
                <div className="card-body">
            ...
            <div className="col-md-4 mb-4">
              <div className="categoria-card">
                <img src="/images/inicio/herramientas.png" alt="Herramientas" />
                <div className="card-body">
                  <h5>HERRAMIENTAS</h5>
                </div>
              </div>
            ...
            <div className="col-md-4 mb-4">
              <div className="categoria-card">
                <img src="/images/inicio/frutas.jpg" alt="Frutas" />
                <div className="card-body">
                  <h5>Frutas</h5>
                </div>
              </div>
